import {
  USER_ADDRESS_MAP_CONFIRM, USER_DELETE_FAIL, USER_DELETE_REQUEST, USER_DELETE_RESET,
  ...
  USER_SIGNIN_REQUEST, USER_SIGNIN_SUCCESS, USER_SIGNOUT, USER_TOPSELLERS_LIST_FAIL,
  USER_TOPSELLERS_LIST_REQUEST, USER_TOPSELLERS_LIST_SUCCESS, USER_UPDATE_FAIL,
  USER_UPDATE_PROFILE_FAIL, USER_UPDATE_PROFILE_REQUEST, USER_UPDATE_PROFILE_RESET,
  USER_UPDATE_PROFILE_SUCCESS, USER_UPDATE_REQUEST, USER_UPDATE_RESET,
  USER_UPDATE_SUCCESS,
...
export const userSigninReducer = (state = {}, action) => {
  ...
  switch (type) {
    ...
    case USER_SIGNIN_FAIL:
      return { loading: false, error: payload };
    case USER_SIGNOUT:
      return {};                            //return empty object, data of userInfo removed
    default:
      return state;
  }
};
